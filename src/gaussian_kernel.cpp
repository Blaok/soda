...
#pragma HLS unroll
                if(input_index >= STENCIL_DISTANCE/UNROLL_FACTOR)
                {
                        ...
                        output_index < TILE_SIZE_DIM0*TILE_SIZE_DIM1)
                    {
                        ...
                        uint16_t input_0_0 = stencil_buf[unroll_index+TILE_SIZE_DIM0*0+0];
                        uint16_t input_0_1 = stencil_buf[unroll_index+TILE_SIZE_DIM0*0+1];
                        uint16_t input_0_2 = stencil_buf[unroll_index+TILE_SIZE_DIM0*0+2];
                        uint16_t input_0_3 = stencil_buf[unroll_index+TILE_SIZE_DIM0*0+3];
                        uint16_t input_0_4 = stencil_buf[unroll_index+TILE_SIZE_DIM0*0+4];
                        uint16_t input_1_0 = stencil_buf[unroll_index+TILE_SIZE_DIM0*1+0];
                        uint16_t input_1_1 = stencil_buf[unroll_index+TILE_SIZE_DIM0*1+1];
                        uint16_t input_1_2 = stencil_buf[unroll_index+TILE_SIZE_DIM0*1+2];
                        uint16_t input_1_3 = stencil_buf[unroll_index+TILE_SIZE_DIM0*1+3];
                        uint16_t input_1_4 = stencil_buf[unroll_index+TILE_SIZE_DIM0*1+4];
                        uint16_t input_2_0 = stencil_buf[unroll_index+TILE_SIZE_DIM0*2+0];
                        uint16_t input_2_1 = stencil_buf[unroll_index+TILE_SIZE_DIM0*2+1];
                        uint16_t input_2_2 = stencil_buf[unroll_index+TILE_SIZE_DIM0*2+2];
                        uint16_t input_2_3 = stencil_buf[unroll_index+TILE_SIZE_DIM0*2+3];
                        uint16_t input_2_4 = stencil_buf[unroll_index+TILE_SIZE_DIM0*2+4];
                        uint16_t input_3_0 = stencil_buf[unroll_index+TILE_SIZE_DIM0*3+0];
                        uint16_t input_3_1 = stencil_buf[unroll_index+TILE_SIZE_DIM0*3+1];
                        uint16_t input_3_2 = stencil_buf[unroll_index+TILE_SIZE_DIM0*3+2];
                        uint16_t input_3_3 = stencil_buf[unroll_index+TILE_SIZE_DIM0*3+3];
                        uint16_t input_3_4 = stencil_buf[unroll_index+TILE_SIZE_DIM0*3+4];
                        uint16_t input_4_0 = stencil_buf[unroll_index+TILE_SIZE_DIM0*4+0];
                        uint16_t input_4_1 = stencil_buf[unroll_index+TILE_SIZE_DIM0*4+1];
                        uint16_t input_4_2 = stencil_buf[unroll_index+TILE_SIZE_DIM0*4+2];
                        uint16_t input_4_3 = stencil_buf[unroll_index+TILE_SIZE_DIM0*4+3];
                        uint16_t input_4_4 = stencil_buf[unroll_index+TILE_SIZE_DIM0*4+4];
                           ...
                           q < var_gaussian_y_min_1 + var_gaussian_y_extent_1)
                        {
                            ...
                            output[output_index] = assign_203;
                        }
                    }
