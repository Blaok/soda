...
#pragma HLS unroll factor=UNROLL_FACTOR
                ...
                uint8_t input_0_0 = input[TILE_SIZE_DIM0*(j+0)+i+0];
                uint8_t input_0_1 = input[TILE_SIZE_DIM0*(j+0)+i+1];
                uint8_t input_0_2 = input[TILE_SIZE_DIM0*(j+0)+i+2];
                uint8_t input_1_0 = input[TILE_SIZE_DIM0*(j+1)+i+0];
                uint8_t input_1_1 = input[TILE_SIZE_DIM0*(j+1)+i+1];
                uint8_t input_1_2 = input[TILE_SIZE_DIM0*(j+1)+i+2];
                uint8_t input_2_0 = input[TILE_SIZE_DIM0*(j+2)+i+0];
                uint8_t input_2_1 = input[TILE_SIZE_DIM0*(j+2)+i+1];
                uint8_t input_2_2 = input[TILE_SIZE_DIM0*(j+2)+i+2];
                   ...
                   q < var_threshold_y_min_1 + var_threshold_y_extent_1)
                {
                    ...
                    output[TILE_SIZE_DIM0*j+i] = (uint8_t)assign_130;
