#ifndef GRADIENT_PARAMS_H_
#define GRADIENT_PARAMS_H_
...
#ifndef BURST_LENGTH
#define BURST_LENGTH 50000     // in pixels
#endif//BURST_LENGTH
...
#define STENCIL_DISTANCE ((TILE_SIZE_DIM_0)*2+1)
