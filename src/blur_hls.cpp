...
#define BLUR_Y_DEPTH (((1998+TILE_SIZE_DIM0-STENCIL_DIM0)/(TILE_SIZE_DIM0-STENCIL_DIM0+1))*((998+TILE_SIZE_DIM1-STENCIL_DIM1+1)/(TILE_SIZE_DIM1-STENCIL_DIM1+1))/(BURST_WIDTH/PIXEL_WIDTH))
#define P0_DEPTH (BLUR_Y_DEPTH)
...
void compute(bool compute_flag, uint16_t output[TILE_SIZE_DIM0*TILE_SIZE_DIM1], uint16_t input[TILE_SIZE_DIM0*TILE_SIZE_DIM1], int32_t tile_index, int32_t tile_num_dim0, int32_t var_blur_y_extent_0, int32_t var_blur_y_extent_1, int32_t var_blur_y_min_0, int32_t var_blur_y_min_1)
{
    if(compute_flag)
    {
...
#pragma HLS unroll factor=UNROLL_FACTOR
                ...
                uint16_t input_0 = input[TILE_SIZE_DIM0*(j+0)+i+0];
                uint16_t input_1 = input[TILE_SIZE_DIM0*(j+0)+i+1];
                uint16_t input_2 = input[TILE_SIZE_DIM0*(j+0)+i+2];
                uint16_t input_3 = input[TILE_SIZE_DIM0*(j+1)+i+0];
                uint16_t input_4 = input[TILE_SIZE_DIM0*(j+1)+i+1];
                uint16_t input_5 = input[TILE_SIZE_DIM0*(j+1)+i+2];
                uint16_t input_6 = input[TILE_SIZE_DIM0*(j+2)+i+0];
                uint16_t input_7 = input[TILE_SIZE_DIM0*(j+2)+i+1];
                uint16_t input_8 = input[TILE_SIZE_DIM0*(j+2)+i+2];
                   ...
                   q < var_blur_y_min_1 + var_blur_y_extent_1)
                {
                    ...
                    output[TILE_SIZE_DIM0*j+i] = assign_128;
