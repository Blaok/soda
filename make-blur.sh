...
sed -i 's/#pragma HLS INTERFACE m_axi port=var_blur_y offset=slave depth=.* bundle=gmem1 latency=120/#pragma HLS INTERFACE m_axi port=var_blur_y offset=slave depth='${INPUT_DEPTH}' bundle=gmem1 latency=120/' src/${KERNEL_SRCS}
